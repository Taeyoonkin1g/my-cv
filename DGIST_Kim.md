# Cover Letter for Prof. Bonghoon Kim (DGIST)

**Target Email:** bonghoonkim@gmail.com
**Subject:** [Research RA Application] Electronics Student Proficient in PSpice & ToF DAQ – Tae-Yoon Kang

Dear Professor Kim,

I hope this email finds you well.

My name is Tae-Yoon Kang, a 3rd-year undergraduate student majoring in Electronic Engineering at Gyeongsang National University (GNU). I am writing to express my sincere interest in joining your Intelligent Sensor Systems Laboratory (Bonghoon Kim Group) at the Department of Robotics and Mechatronics Engineering as an Undergraduate Research Assistant for the upcoming semester and winter internship.
...
* **Hardware Interfacing & Data Handling:** Experienced in building embedded DAQ prototypes on Raspberry Pi, implementing SPI protocols with ADC (MCP3008) architectures, and calibrating physical sensors using the Time-of-Flight (ToF) principle to extract exact dimensional metrics within reliable error margins.
